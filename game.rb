...
class Game
  ...
  def check_for_similarities(bukva)
    if bukva == "е" || bukva == "ё"
      yo_ee
    elsif bukva == "й" || bukva == "и"
      ikratkaya_i
    else
      return
    end
  ...
  def yo_ee
    if letters.include?("ё") || letters.include?("е")
      @good_letters << "е"
      @good_letters << "ё"
      return
    else
  ...
  def ikratkaya_i
    if letters.include?("й") || letters.include?("й")
      @good_letters << "й"
      @good_letters << "и"
      return
    else
